use crate::{error::Result, pipeline_layouts::PipelineLayoutCacheKey, pipelines::compute_pipeline::{ComputePipelineCacheKey, ComputePipelineKey}, render_passes::{composite::{bind_group::CompositeBindGroups, shader::cache_key::ShaderCacheKeyComposite}, RenderPassInitContext}};
...
impl CompositePipelines {
    pub async fn new(ctx: &mut RenderPassInitContext, bind_groups: &CompositeBindGroups) -> Result<Self> {
